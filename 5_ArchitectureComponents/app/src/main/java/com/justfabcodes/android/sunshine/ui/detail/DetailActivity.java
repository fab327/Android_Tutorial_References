...
import com.justfabcodes.android.sunshine.R;
import com.justfabcodes.android.sunshine.data.database.WeatherEntry;
import com.justfabcodes.android.sunshine.databinding.ActivityDetailBinding;
import com.justfabcodes.android.sunshine.utilities.InjectorUtils;
import com.justfabcodes.android.sunshine.utilities.SunshineDateUtils;
import com.justfabcodes.android.sunshine.utilities.SunshineWeatherUtils;
...
public class DetailActivity extends AppCompatActivity implements LifecycleOwner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Requires layout root to be <layout></layout>
        mDetailBinding = DataBindingUtil.setContentView(this, R.layout.activity_detail);
        factory = InjectorUtils.provideDetailViewModelFactory(this, date);
...
//                Thread.sleep(TimeUnit.SECONDS.toSeconds(4));
//                Date today = SunshineDateUtils.getNormalizedUtcDateForToday();
//                WeatherEntry pretendWeatherFromDatabase = new WeatherEntry(1, 210, today, 88, 99, 71, 1030, 74, 5);
//                mViewModel.setWeather(pretendWeatherFromDatabase);
//
//                Thread.sleep(2000);
//                pretendWeatherFromDatabase = new WeatherEntry(1, 952, today, 50, 60, 46, 1044, 70, 100);
//                mViewModel.setWeather(pretendWeatherFromDatabase);
