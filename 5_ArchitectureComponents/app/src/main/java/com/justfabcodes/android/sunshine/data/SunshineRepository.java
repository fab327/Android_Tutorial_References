...
package com.justfabcodes.android.sunshine.data;

import android.arch.lifecycle.LiveData;
import android.util.Log;

import com.justfabcodes.android.sunshine.AppExecutors;
import com.justfabcodes.android.sunshine.data.database.WeatherDao;
...
public class SunshineRepository {
    ...
    private SunshineRepository(WeatherDao weatherDao,
        ...
        LiveData<WeatherEntry[]> networkData = mWeatherNetworkDataSource.getCurrentWatherForecast();
        networkData.observeForever(newForecastsFromNetwork -> {
            mExecutors.diskIO().execute(() -> {
                deleteOldData();
                Log.d(LOG_TAG, "Old weather values deleted");
    ...
    private void deleteOldData() {
        ...
        mWeatherDao.deleteOldWeatherData(today);
    }
