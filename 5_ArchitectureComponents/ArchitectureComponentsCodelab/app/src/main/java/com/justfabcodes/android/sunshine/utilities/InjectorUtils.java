...
package com.justfabcodes.android.sunshine.utilities;

import android.content.Context;

import com.justfabcodes.android.sunshine.AppExecutors;
import com.justfabcodes.android.sunshine.data.SunshineRepository;
import com.justfabcodes.android.sunshine.data.database.SunshineDatabase;
import com.justfabcodes.android.sunshine.data.network.WeatherNetworkDataSource;
import com.justfabcodes.android.sunshine.ui.detail.DetailViewModelFactory;
import com.justfabcodes.android.sunshine.ui.list.MainViewModelFactory;
...
public class InjectorUtils {
    ...
    public static SunshineRepository provideRepository(Context context) {
        SunshineDatabase database = SunshineDatabase.Companion.getInstance(context.getApplicationContext());
