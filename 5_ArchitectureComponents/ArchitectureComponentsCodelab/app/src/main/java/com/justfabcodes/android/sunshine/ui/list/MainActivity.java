...
import com.justfabcodes.android.sunshine.ui.detail.DetailActivity;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainViewModelFactory = InjectorUtils.provideMainActivityViewModelFactory(this);
        mainActivityViewModel = ViewModelProviders.of(this, mainViewModelFactory).get(MainActivityViewModel.class);
        mainActivityViewModel.getWeatherEntries().observe(this, weatherEntries -> {
