...
/*
 * https://codelabs.developers.google.com/codelabs/android-smart-lock/index.html?index=../../index#0
 */
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        //Only required for pre O devices
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        // Request Credentials once connected. If credentials are retrieve the user will either be
        // automatically signed in or will be presented with credential options to be used by the
    ...
    /*
     * This only required for devices pre-Oreo.
     * On Oreo, the autofill service (has to be enabled) will fetch credentials for us
     */
